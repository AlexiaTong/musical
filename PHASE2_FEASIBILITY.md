...
| West End | London Theatre Direct | 2026-09-15 | Pass | Its catalogue exposes current musical detail pages; the adapter checks a bounded set of those pages and retains only performances explicitly tied to the selected date. |
...
The live adapters therefore use Broadway.com, London Theatre Direct, and Musical1. Broadway and Germany use one bounded catalogue scrape; London Theatre Direct uses one catalogue scrape followed by at most sixteen approved musical detail-page scrapes because its exact schedules live on those pages. Coverage is intentionally limited to verified facts and is not a claim of exhaustive market coverage.
